...
import { Switch, List, Avatar, Button, notification, Modal as ModalAntd , Tooltip} from 'antd';
import NoAvatar from '../../../../assets/img/png/no-avatar.png';
import { EditOutlined, StopOutlined, DeleteOutlined, CheckOutlined, CodepenCircleOutlined } from '@ant-design/icons';
import Modal from '../../../Modal';
import EditUserForm from '../EditUserForm';
import { getAvatarApi, activateUserApi, deleteUserApi, activeAddCourse } from '../../../../api/user';
...
export default function ListUserDocentes(props) {
	...
	const addUserModal = () => {
		...
		setModalContent(<AddUserDocente setIsVisibleModal={setIsVisibleModal} setReloadUsers={setReloadUsers} />);
	};
		...
		<div className="list-users">
			<div className="list-users__header">
				<div className="list-users__header-switch">
					<Switch defaultChecked onChange={() => setviewUserActives(!viewUserActives)} />
...
function UsersActive(props) {
	...
	return (
		<List
			...
			renderItem={(user) => <UserActive user={user} editUserDoc={editUserDoc} setReloadUsers={setReloadUsers} />}
		/>
	);
}
function UserActive(props) {
	...
	return (
		<List.Item
			actions={[
				<Button className="botonw" type="primary" onClick={() => editUserDoc(user)}>
